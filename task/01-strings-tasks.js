...
function getRectangleString(width, height) {
    ...
    let w = width - 2;
    let h = height - 2;
    let topLinePush, bottomLinePush, lineSpacePush
    for (let i = 1; i <= height; i++) {
        if (str1 == i) {
            topLinePush = (function () {
                return "┌" + '─'.repeat(w) + "┐\n";
            })();
        } else if (str2 == i) {
            bottomLinePush = (function () {
                return "└" + '─'.repeat(w) + "┘\n";
            })();
        } else {
            lineSpacePush = (function () {
                return "│" + ' '.repeat(w) + "│\n";
            })();
        }
    }
    if (h === 0) {
       ...
       lineSpacePush = lineSpacePush.repeat(h);
    }
    return topLinePush + lineSpacePush + bottomLinePush;
}
